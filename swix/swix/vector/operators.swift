...
public func make_operator(_ lhs:vector, operation:String, rhs:vector) -> vector{
...
public func make_operator(_ lhs:vector, operation:String, rhs:Double) -> vector{
...
public func make_operator(_ lhs:Double, operation:String, rhs:vector) -> vector{
